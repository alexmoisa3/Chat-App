...
export class MyApp {
  ...
  pages: any[] = [
    { icon: 'contacts', title: 'Prieteni', component: 'ListFriendsPage' },
    { icon: 'contact', title: 'Profilul Meu', component: 'MyProfilePage' },
    { icon: 'log-out', title: 'Deconectare', component: 'LoginPage' }
  ];
